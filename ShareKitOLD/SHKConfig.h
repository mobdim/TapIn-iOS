...
#define SHKMyAppName			@"TapIn"
#define SHKMyAppURL				@"http://tapin.tv"
...
#define SHKFacebookKey				@"161346993997086"
#define SHKFacebookSecret			@"fee9e776c15ba0f5ffb47bfe2fe0549b"
 ...
 */
#define SHKTwitterConsumerKey		@"RpEN4JDQglF8l8JvyLaAg"
#define SHKTwitterSecret			@"1ndGC25Kk6IpXiWRXzWgDADSDt15EbNZbQDQCAwqqY"
#define SHKTwitterCallbackUrl		@"http://tapin.tv" // You need to set this if using OAuth, see note above (xAuth users can skip it)
...
#define SHKBitLyLogin				@"vu0tran"
#define SHKBitLyKey					@"R_8863b863492a156700e634ae8accacb3"
